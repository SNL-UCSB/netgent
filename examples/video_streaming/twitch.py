...
try:
    with open("examples/streaming/twitch/results/twitch_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("examples/streaming/twitch/results", exist_ok=True)
with open("examples/streaming/twitch/results/twitch_result.json", "w") as f:
