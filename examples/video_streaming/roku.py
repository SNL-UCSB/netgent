...
try:
    with open("examples/streaming/roku/results/roku_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("examples/streaming/roku/results", exist_ok=True)
with open("examples/streaming/roku/results/roku_result.json", "w") as f:
