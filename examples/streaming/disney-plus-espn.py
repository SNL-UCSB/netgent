...
try:
    with open("streaming/disney-plus-espn/results/disney-plus-espn_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("streaming/disney-plus-espn/results", exist_ok=True)
with open("streaming/disney-plus-espn/results/disney-plus-espn_result.json", "w") as f:
