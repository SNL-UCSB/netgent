...
if os.path.exists("examples/isps/results/ezeefiber_result.json"):
    with open("examples/isps/results/ezeefiber_result.json", "r") as f:
        try:
            data = json.load(f)
...
with open("examples/isps/results/ezeefiber_robust_results.json", "w") as f:
