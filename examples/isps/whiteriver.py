...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to White River Connect page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://whiteriver.crowdfiber.com/front_end/zones word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the White River Connect page",
    ...
    StatePrompt(
        ...
        triggers=["If you see 'White River Connect is in your neighborhood. Order now!'"],
        actions=[
...
try:
    with open("examples/isps/results/whiteriver_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/whiteriver",
    session="whiteriver"
)
...
with open("examples/isps/results/whiteriver_result.json", "w") as f:
