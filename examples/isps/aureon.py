...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to Aureon page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://connect.aureon.com/front_end word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the Aureon page",
    ...
    StatePrompt(
        name="NO_SERVICE",
        description="Service not available - (e.g. 'Aureon does not currently have commercial services available in your area. We are able to work with partners throughout the United States to help support the data and network needs of businesses like yours. If you are interested in exploring our partner network options, please provide your contact information below. An Aureon expert will reach out to you regarding your request.')",
        triggers=["If you see 'Aureon does not currently have commercial services available in your area. We are able to work with partners throughout the United States to help support the data and network needs of businesses like yours. If you are interested in exploring our partner network options, please provide your contact information below. An Aureon expert will reach out to you regarding your request.'"],
        actions=["DON'T DO ANYTHING, JUST TERMINATE AT THIS POINT"],
...
if os.path.exists("examples/isps/results/aureon_result.json"):
    with open("examples/isps/results/aureon_result.json", "r") as f:
        try:
            data = json.load(f)
...
result = agent.run(
    ...
    session="aureon",
    save_content_dir="examples/isps/save/aureon"
)
