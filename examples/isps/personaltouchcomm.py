...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to Personal Touch Comm CrowdFiber page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://personaltouchcomm.crowdfiber.com/front_end word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the Personal Touch Comm page",
...
if os.path.exists("examples/isps/results/personaltouchcomm_result.json"):
    with open("examples/isps/results/personaltouchcomm_result.json", "r") as f:
        try:
            data = json.load(f)
...
with open("examples/isps/results/personaltouchcomm_result.json", "w") as f:
