...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to RightFiber CrowdFiber page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://get.rightfiber.com/front_end/ word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the RightFiber page",
...
result = agent.run(
    ...
    session="rightfiber",
    save_content_dir="examples/isps/save/rightfiber"
)
...
with open("examples/isps/results/rightfiber_result.json", "w") as f:
