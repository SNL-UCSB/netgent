...
if os.path.exists("examples/isps/results/woodruffelectric_result.json"):
    with open("examples/isps/results/woodruffelectric_result.json", "r") as f:
        try:
            data = json.load(f)
...
result = agent.run(
    ...
    session="woodruffelectric",
    save_content_dir="examples/isps/save/woodruffelectric"
)
...
with open("examples/isps/results/woodruffelectric_result.json", "w") as f:
