...
prompts = [
        StatePrompt(
            ...
            actions=["Go to https://www.wyyerd.com word for word", "TERMINATE AT THIS POINT"],
        ),
        StatePrompt(
            name="ADDRESS_BAR",
            ...
            actions=[
                ...
                "All the way Scroll down to the page",
...
try:
    with open("examples/isps/results/wyyerd_result.json", "r") as f:
