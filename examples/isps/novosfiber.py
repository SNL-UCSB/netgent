...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to Novos Fiber page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://novosfiber.com/ word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the Novos Fiber page",
    ...
    StatePrompt(
        ...
        triggers=["If you see 'Novos Fiber is in your neighborhood. Order now!'"],
        actions=[
...
try:
    with open("examples/isps/results/novosfiber_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/novosfiber",
    session="novosfiber"
)
...
with open("examples/isps/results/novosfiber_result.json", "w") as f:
