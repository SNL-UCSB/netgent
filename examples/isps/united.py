...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to United page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://shop.united.net/ word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the United page",
    ...
    StatePrompt(
        ...
        triggers=["If you see 'United is in your neighborhood. Order now!'"],
        actions=[
...
try:
    with open("examples/isps/results/united_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/united",
    session="united"
)
...
with open("examples/isps/results/united_result.json", "w") as f:
