...
prompts = [
        StatePrompt(
            name="START",
            description="Navigate to the Glo Fiber availability page",
            triggers=["If it is on the chrome homescreen"],
            actions=["Go to https://www.glofiber.com/en/homepage", "TERMINATE AT THIS POINT"],
        ),
        StatePrompt(
            name="ADDRESS_BAR",
...
addresses = [
    {"address": "682 Adagio Way, San Jose, CA, 95111"},
    {"address": "8 Birch Ln, San Jose, CA, 95127"},
    {"address": "7 Cedar Ln, San Jose, CA, 95127"},
    {"address": "H Berry Dr, Mountain View, CA, 94043"}
]
...
try:
    with open("examples/isps/results/glofiber_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/glofiber",
    session="glofiber"
)
...
with open("examples/isps/results/glofiber_result.json", "w") as f:
