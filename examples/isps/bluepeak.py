...
prompts = [
        StatePrompt(
            name="START",
            description="Navigate to the Quantum Fiber availability page",
            triggers=["If it is on the chrome homescreen"],
            actions=["Go to https://mybluepeak.com/internet/ word for word", "TERMINATE AT THIS POINT"],
        ),
        StatePrompt(
            name="ADDRESS_BAR",
            ...
            actions=[
                ...
                "Click on the address text box and press enter key",
        ...
        StatePrompt(
            ...
            triggers=["If you see 'Fiber internet may be available at your address!'"],
            actions=["TERMINATE AT THIS POINT"],
...
try:
    with open("examples/isps/results/bluepeak_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/bluepeak",
    session="bluepeak"
)
...
with open("examples/isps/results/bluepeak_result.json", "w") as f:
