...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to Vexus Fiber page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://signup.vexusfiber.com/vssu word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the Vexus Fiber page",
    ...
    StatePrompt(
        ...
        triggers=["If you see 'Vexus Fiber is in your neighborhood. Order now!'"],
        actions=[
    ...
    StatePrompt(
        ...
        triggers=["If you see 'Aww shucks! or you see the T Mobile page'"],
        actions=["TERMINATE AT THIS POINT"],
...
try:
    with open("examples/isps/results/vexusfiber_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/vexusfiber",
    session="vexusfiber"
)
...
with open("examples/isps/results/vexusfiber_result.json", "w") as f:
