...
prompts = [
    StatePrompt(
        name="START",
        description="Navigate to Blackfoot page",
        triggers=["If it is on the chrome homescreen"],
        actions=["Go to https://fiber.blackfoot.com/front_end word for word", "TERMINATE AT THIS POINT"],
    ),
    StatePrompt(
        name="ADDRESS_BAR",
        description="If on the Blackfoot page",
    ...
    StatePrompt(
        ...
        triggers=["If you see 'Blackfoot is in your neighborhood. Order now!'"],
        actions=[
...
try:
    with open("examples/isps/results/blackfoot_result.json", "r") as f:
...
result = agent.run(
    ...
    save_content_dir="examples/isps/save/blackfoot",
    session="blackfoot"
)
...
with open("examples/isps/results/blackfoot_result.json", "w") as f:
