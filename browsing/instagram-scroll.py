...
try:
    with open("browsing/instagram-scroll/results/instagram-scroll_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("browsing/instagram-scroll/results", exist_ok=True)
with open("browsing/instagram-scroll/results/instagram-scroll_result.json", "w") as f:
