...
try:
    with open("conference/google-meet/results/google-meet_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("conference/google-meet/results", exist_ok=True)
with open("conference/google-meet/results/google-meet_result.json", "w") as f:
