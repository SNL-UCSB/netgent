...
try:
    with open("conference/jitsi/results/jitsi_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("conference/jitsi/results", exist_ok=True)
with open("conference/jitsi/results/jitsi_result.json", "w") as f:
